# Algorithmic Art — p5.js (2D Engine)

Expertise in 2D generative art using p5.js. Use this skill for flat, canvas-based visualizations: waveforms, signal flow diagrams, frequency curves, flow fields, fractals, tessellations, particle systems, and all traditional 2D algorithmic art.

## When to Use p5.js

p5.js is the right choice when the artwork is inherently **two-dimensional**:
...
Every p5.js artwork must have at least 2 distinct algorithmic layers:
...
- Use `noLoop()` for static art — single render
