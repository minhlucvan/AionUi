# Algorithmic Art — Three.js (3D Engine)

Expertise in 3D generative art and visualization using Three.js. Use this skill for spatial concepts: room acoustics, spatial audio, speaker placement, 3D particle systems, terrain, architectural visualization, molecular structures, and any artwork that benefits from depth, perspective, and camera control.

## When to Use Three.js

Three.js is the right choice when the artwork is inherently **three-dimensional**:
...
function downloadPNG() {
  ...
  link.download = 'artwork_seed_' + currentSeed + '.png';
