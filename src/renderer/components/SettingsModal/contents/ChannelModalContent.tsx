...
const ChannelModalContent: React.FC = () => {
  ...
  // Load saved model selection for Mezon
  useEffect(() => {
    ...
    const loadSavedModel = async () => {
      try {
        ...
        console.error('[ChannelSettings] Failed to load saved Mezon model:', error);
      }
    };
  ...
  const channels: ChannelConfig[] = useMemo(() => {
    ...
    return [telegramChannel, larkChannel, mezonChannel, dingtalkChannel, ...comingSoonChannels];
  }, [pluginStatus, larkPluginStatus, mezonPluginStatus, dingtalkPluginStatus, selectedModel, larkSelectedModel, mezonSelectedModel, telegramModelSelection, larkModelSelection, dingtalkModelSelection, modelList, enableLoading, larkEnableLoading, mezonEnableLoading, dingtalkEnableLoading, t]);
