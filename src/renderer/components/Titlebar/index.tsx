...
const Titlebar: React.FC<TitlebarProps> = ({ workspaceAvailable }) => {
  ...
  return (
    ...
    >
      <div ref={menuRef} className='app-titlebar__menu flex items-center gap-8px' style={menuStyle}>
        <Logo size={32} />
      ...
      {layout ? <ModeTabs activeMode={layout.appMode} onChange={layout.setAppMode} /> : (
