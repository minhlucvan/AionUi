...
export declare const AI_PROVIDERS: readonly ["claude", "gemini", "codex", "acp"];
...
export declare function isPluginAgentInstance(agent: PluginAgent): agent is IPluginAgent;
/**
