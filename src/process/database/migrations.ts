...
/**
 * Migration v10 -> v11: Add 'mezon' to assistant_plugins type constraint
...
const migration_v11: IMigration = {
  ...
  up: (db) => {
    ...
    console.log('[Migration v11] Added mezon to assistant_plugins type constraint');
  },
  down: (db) => {
    ...
    db.exec(`
      ...
      CREATE INDEX IF NOT EXISTS idx_assistant_plugins_enabled ON assistant_plugins(enabled);
    `);
    console.log('[Migration v11] Rolled back: Removed mezon from assistant_plugins type constraint');
  },
};
